                            ...
                            <div className="lg:pl-20">
                                <div className="mb-6 ">
                                    ...
                                    <div className="flex flex-wrap items-center mb-6">
                                        ...
                                        <a className="mb-4 text-xs underline hover:text-red-600 dark:text-gray-400 dark:hover:text-gray-300 lg:mb-0" href="#">
                                            View the acer store
                                        </a>
                                    </div>
                                ...
                                <div className="py-6 mb-6 border-t border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="mt-2 text-sm text-red-500 dark:text-red-200">Ships from china.
                                ...
                                <div className="flex flex-wrap items-center mb-6">
                                    ...
                                    <a href="#" className="w-full px-4 py-3 text-center text-red-600 bg-red-100 border border-red-600 dark:hover:bg-gray-900 dark:text-gray-400 dark:border-gray-700 dark:bg-gray-700 hover:bg-red-600 hover:text-gray-100 lg:w-1/2 rounded-xl">
                                        Add to cart
                                    </a>
                                </div>
                                <div className="flex gap-4 mb-6">
                                    <a href="#" className="w-full px-4 py-3 text-center text-gray-100 bg-red-600 border border-transparent dark:border-gray-700 hover:border-red-500 hover:text-red-700 hover:bg-red-100 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-900 rounded-xl">
                                        Buy now</a>
                                </div>
                            </div>
                        </div>
