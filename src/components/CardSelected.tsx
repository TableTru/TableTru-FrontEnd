...
import IconBottonSelect from "@/components/botton/IconBottonSelect";
...
export default function Component() {
  ...
  return(
    <div className="max-w-[900px] gap-2 grid grid-cols-12 px-8">
      {/*list โค๊ตส่วนลด*/}
    <Card className="col-span-10 sm:col-span-4 h-[300px]" isPressable onPress={() => router.push('/promo')}>
    ...
    <Card className="col-span-10 sm:col-span-4 h-[300px]"  isPressable onPress={() => router.push('/products')}>
      <CardHeader className="absolute z-10 top-1 flex-col !items-start">
